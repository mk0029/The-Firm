        ...
        <div className="container py-lg-4">
          <div className="row align-items-center justify-content-between py-lg-3">
            <div className="col-lg-6">
              <h2 className="ff_Nunito fs_4xxl fw_bolder mb-0 clr_light_black">
                Frustration of{" "}
                <span className=" position-relative z_index2 after_yellow_line">
                  Clients
                </span>
              </h2>
              <p className=" ff_Lora fs_xl clr_light_black fw-normal mb-0 mt-sm-3 pt-1 pe-xl-5 me-lg-3">
              ...
              <div className="ps-lg-4">
                <div className="d-flex align-items-center mt-sm-4 mt-3">
                  ...
                  <p className=" mb-0 fw-normal ff_Lora fs_xl clr_light_black ms-2">
                ...
                <div className="d-flex mt-2 pt-1">
                  <img
                    ...
                    alt="question_mark"
                  />
                  <p className=" mb-0 fw-normal ff_Lora fs_xl clr_light_black ms-2 me-xl-5 pe-xl-5">
