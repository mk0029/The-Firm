    ...
    <>
      ...
      >
        ...
        <div className="container flex-grow-1 d-flex align-items-center justify-content-center mb-xl-5 mt-4 mt-md-0">
          <div className="row align-items-center w-100 pt-md-5">
            <div className="col-lg-6">
              <div className="mt-lg-5 mt-xl-4 mt-lg-0 mb-xl-4">
                <h1 className="ff_Nunito fw_bolder fs_5xl clr_light_black mb-0 mt-2 mt-xl-0">
                  Get Bussiness{" "}
            ...
            <div className="col-lg-6 d-lg-none mt-5">
              <div>
