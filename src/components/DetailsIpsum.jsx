    ...
    <>
      <section className=" py-5 lorem_ipsum_bg mb-sm-5" id="DetailIpsum">
        <div className="container py-lg-4">
          ...
          <p
            className=" mt-3 ff_Lora fw-normal fs_xl clr_light_black mb-0 pe-lg-5"
            data-aos="fade-right"
            data-aos-easing="linear"
            data-aos-duration="1500"
          >
          ...
          <div className="d-flex align-items-start mt-sm-4 mt-3 pt-sm-2">
            ...
            />
            <p
              className=" mb-0 ff_Lora fw-normal fs_xl clr_light_black ms-2 pe-lg-5"
              data-aos="fade-left"
              data-aos-easing="linear"
              data-aos-duration="1500"
            >
          ...
          <div className="d-flex align-items-start mt-2">
            ...
            />
            <p
              className=" mb-0 ff_Lora fw-normal fs_xl clr_light_black ms-2"
              data-aos="fade-left"
              data-aos-easing="linear"
              data-aos-duration="1500"
            >
